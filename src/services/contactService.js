...
function deleteContact(id) {
  ...
  if (!contacts.length) contacts = gDefaultContacts.slice()
...
function _loadContacts() {
  let storegeContacts = storageService.load(STORAGE_KEY)
  if (!storegeContacts || !storegeContacts.length) storegeContacts = gDefaultContacts
  storageService.store(STORAGE_KEY, storegeContacts)
  return storegeContacts
}
